...
export default function TermsAndConditions() {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Masud Rana</title>
      </Head>
      <TermsAndConditionsContainer>
        ...
        <p>Welcome to Masud's Portfolio. By accessing or using this website, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please do not use this site.</p>

        <h3>1. Acceptance of Terms</h3>
        <p>By using Masud's Portfolio, you acknowledge that you have read, understood, and agree to these Terms and Conditions, along with the Privacy Policy.</p>
        ...
        <p>Masud's Portfolio is provided "as is," without warranties of any kind.</p>
        ...
        <p>Modifications made to the site by <strong>Masud Rana</strong> are for personal, non-commercial use only. Unauthorized use is prohibited outside the scope of personal use.</p>
